            ...
            <div
                ...
                <form wire:submit.prevent="updateParole">
                    <div class="space-y-6" x-data="{
                        ...
                        <!-- Escape Date Field -->
                        <div>
                            <label for="transfer_date" class="block mb-2 text-sm font-medium text-gray-700">Date of Transfer</label>
                            <input type="date" wire:model.live="transfer_date" id="transfer_date"
