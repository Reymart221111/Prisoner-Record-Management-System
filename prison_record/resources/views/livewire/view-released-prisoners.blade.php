...
<div class="container mx-auto" x-data="{openEditModal: false }">
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Prisoner Releases Management</h1>
    </div>
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
            ...
            <div>
                <select wire:model.live="sortField"
                    ...
                    <option value="release_date">Transfer Date</option>
    ...
    @livewire('update-prisoner-releases')
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900">{{Carbon::parse($prisoner->release_date)->format('M d, Y')}}
                        </div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <td class="px-6 py-4 text-sm font-medium whitespace-nowrap">
                        <button @click="openEditModal = true"
                            wire:click='$dispatch("editTransferedPrisoner", {recordId: {{ $prisoner->id }} })'
