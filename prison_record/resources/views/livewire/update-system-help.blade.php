<div id="top" class="max-w-4xl mx-auto mt-10">
    <!-- Flash Messages -->
    ...
    <div class="bg-white rounded-lg shadow-md">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-900">Update Help Article</h3>
        ...
        <!-- Form Content -->
        <div class="p-6">
            <form wire:submit.prevent="updateSystemHelpArticle">
                <!-- Title -->
                <div class="mb-6">
                ...
                <div wire:ignore>
                    ...
                    <trix-editor data-trix-editor input="content"
                        ...
                        style="min-height: 20rem;"></trix-editor>
                </div>

                <!-- Form Actions -->
                <div @help-updated.window="" class="flex items-center justify-end space-x-3 border-t pt-6">

                    <!-- 3) Scroll to Top Link -->
                    <a id="scrollButton" href="#top"
                    ...
                    <!-- Cancel -->
                    <button type="button" x-data="{ url: '{{ url()->previous() }}' }"
                        @click="window.location.href = url"
                        class="px-4 py-2 text-sm text-white bg-red-600 border border-red-700 rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
                        Cancel
                    </button>
