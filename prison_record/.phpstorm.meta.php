...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'activitylog.database_connection' => 'string',
            'app.name' => 'string',
            'app.env' => 'string',
            'app.debug' => 'boolean',
            'app.url' => 'string',
            ...
            'filesystems.links.C:\wamp64\www\prison_record\prison_record\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.links.C:\\wamp64\\www\\prison_record\\prison_record\\public\\storage','livewire.class_namespace','livewire.view_path','livewire.layout',
...
'debugbar.route_middleware','debugbar.route_domain','debugbar.theme','debugbar.debug_backtrace_limit','ide-helper.filename',
...
'livewire.preview-file','home','login','login_user',
'logout','superadmin.dashboard','superadmin.update.photo.show','superadmin.update.photo','superadmin.update.account.show',
'superadmin.update.password.show','superadmin.prisoners.search','superadmin.prisoners.index','superadmin.prisoners.show','superadmin.prisoners.create',
'superadmin.prisoners.update','superadmin.crimes.index','superadmin.crimes.create','superadmin.crimes.update','superadmin.crimes.search',
'superadmin.crimes.prisoner-crimes.index','superadmin.crimes.prisoner-crimes-list.index','superadmin.crimes.prisoner-crimes.attach','superadmin.crimes.prisoner-crimes.update','superadmin.medical-records.index',
'superadmin.medical-records.prisoner-medical-records','superadmin.medical-records.create','superadmin.medical-records.show','superadmin.medical-records.update','superadmin.prisoner-paroles.index',
'superadmin.escape-prisoners.index','superadmin.disease-prisoners.index','superadmin.transfered-prisoners.index','superadmin.released-prisoners.index','superadmin.user-management.index',
'superadmin.audit.index','superadmin.audit.show','superadmin.feedbacks.index','superadmin.feedbacks.view','superadmin.help.index',
'superadmin.help.create','superadmin.help.show','superadmin.help.update','superadmin.about.index','admin.dashboard',
'admin.update.photo.show','admin.update.photo','admin.update.account.show','admin.update.password.show','admin.prisoners.search',
'admin.prisoners.index','admin.prisoners.show','admin.prisoners.create','admin.prisoners.update','admin.crimes.index',
'admin.crimes.create','admin.crimes.update','admin.crimes.search','admin.crimes.prisoner-crimes.index','admin.crimes.prisoner-crimes-list.index',
'admin.crimes.prisoner-crimes.attach','admin.crimes.prisoner-crimes.update','admin.medical-records.index','admin.medical-records.prisoner-medical-records','admin.medical-records.create',
'admin.medical-records.show','admin.medical-records.update','admin.prisoner-paroles.index','admin.escape-prisoners.index','admin.disease-prisoners.index',
'admin.transfered-prisoners.index','admin.released-prisoners.index','admin.user-management.index','admin.audit.index','admin.audit.show',
'admin.feedbacks.index','admin.help.index','admin.help.show','admin.about.index','employee.dashboard',
'employee.update.photo.show','employee.update.photo','employee.update.account.show','employee.update.password.show','employee.prisoners.search',
'employee.prisoners.index','employee.prisoners.show','employee.prisoners.create','employee.prisoners.update','employee.crimes.prisoner-crimes.index',
'employee.crimes.prisoner-crimes-list.index','employee.crimes.prisoner-crimes.attach','employee.crimes.prisoner-crimes.update','employee.medical-records.index','employee.medical-records.prisoner-medical-records',
'employee.medical-records.create','employee.medical-records.show','employee.medical-records.update','employee.prisoner-paroles.index','employee.escape-prisoners.index',
'employee.disease-prisoners.index','employee.transfered-prisoners.index','employee.released-prisoners.index','employee.feedbacks.index','employee.help.index',
'employee.help.show','employee.about.index','storage.local',);
        registerArgumentsSet('views', 
'auth.login','components.admin.sidebar','components.employee.sidebar','components.superadmin.add_prisoner','components.superadmin.crimes-list',
'components.superadmin.prisoner-crimes-list','components.superadmin.prisoners','components.superadmin.prisoners-table','components.superadmin.recent_prisoners','components.superadmin.show-prisoner',
'components.superadmin.sidebar','components.superadmin.stats_card','contents.account_settings.update-account-settings','contents.account_settings.update-password-settings','contents.account_settings.updateUserImage',
'contents.employee.feedbacks.index','contents.superadmin.about-page.index','contents.superadmin.audit-trail.includes.audit-table','contents.superadmin.audit-trail.index','contents.superadmin.crimes.crimes-table',
'contents.superadmin.dashboard','contents.superadmin.feedbacks.index','contents.superadmin.prisoner-crimes.prisoner-crimes-index','contents.superadmin.prisoner-disease.index','contents.superadmin.prisoner-escapee.index',
'contents.superadmin.prisoner-medical-records.prisoner-medical-records-index','contents.superadmin.prisoner-parole.prisoner-parole-index','contents.superadmin.prisoner-releases.index','contents.superadmin.prisoner-transfferee.index','contents.superadmin.prisoners.create',
'contents.superadmin.prisoners.index','contents.superadmin.prisoners.prisoner-index','contents.superadmin.prisoners.update','contents.superadmin.system-help.index','contents.superadmin.user-management.index',
'includes.account_settings','includes.adding-parole-modal','includes.create-prisoner-form-content','includes.logout_modal','includes.session-message',
'includes.superadmin-search-prisoner-modal','includes.x-data','includes.x-data-update','layouts.livewire.updateAccountSettings','layouts.superAdmin',
'livewire.account-password','livewire.account-settings','livewire.backup','livewire.create-prisoner-form','livewire.delete-crime',
'livewire.feedback-form','livewire.includes.session-message','livewire.prisoner-action-button','livewire.prisoner-attach-crime','livewire.prisoner-update-crime',
'livewire.read-prisoner-crime-list','livewire.read-prisoner-crimes','livewire.read-prisoner-escapee','livewire.read-prisoner-medical-record-list','livewire.read-prisoner-medical-records',
'livewire.read-system-help','livewire.show-system-help','livewire.store-crime','livewire.store-medical-record','livewire.store-prisoner',
'livewire.store-prisoner-parole','livewire.store-system-help','livewire.store-user-role','livewire.update-crime','livewire.update-prisoner',
'livewire.update-prisoner-disease','livewire.update-prisoner-escapee','livewire.update-prisoner-medical-record','livewire.update-prisoner-parole','livewire.update-prisoner-releases',
'livewire.update-prisoner-transfers','livewire.update-system-help','livewire.update-user-permission','livewire.view-dashboard','livewire.view-disease-prisoner',
'livewire.view-feed-back-details','livewire.view-feedback-submission','livewire.view-medical-record','livewire.view-prisoner-parole-list','livewire.view-released-prisoners',
'livewire.view-transffered-prisoners','livewire.view-user-permissions','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'VITE_APP_NAME','ACTIVITY_LOGGER_ENABLED','ACTIVITY_LOGGER_DB_CONNECTION',);
