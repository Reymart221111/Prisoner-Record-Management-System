            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-100 transition-colors duration-150">
                    ...
                    <td class="px-6 py-4 flex space-x-2">
                        ...
                        <a href="{{ route('superadmin.crimes.prisoner-crimes-list.index', $prisoner->id) }}"
                        ...
                        <a href="{{ route('admin.crimes.prisoner-crimes-list.index', $prisoner->id) }}"
                            class="px-3  py-1 bg-gradient-to-r from-green-500 to-green-600 text-white font-semibold rounded-md shadow-sm hover:from-green-600 hover:to-green-700 transition duration-200 ease-in-out inline-block">
                            View Crimes
                        </a>
                        @elseif (Auth::user()->role === 'employee')
                        <a href="{{ route('employee.crimes.prisoner-crimes-list.index', $prisoner->id) }}"
                            class="px-3 py-1 bg-gradient-to-r from-green-500 to-green-600 text-white font-semibold rounded-md shadow-sm hover:from-green-600 hover:to-green-700 transition duration-200 ease-in-out inline-block">
                            View Crimes
                        </a>
                        @endif
