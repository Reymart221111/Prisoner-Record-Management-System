            ...
            <div
                ...
                <form wire:submit.prevent="updateParole">
                    <div class="space-y-6" x-data="{
                        ...
                        <!-- Escape Date Field -->
                        <div>
                            <label for="release_date" class="block mb-2 text-sm font-medium text-gray-700">Release Date</label>
                            <input type="date" wire:model.live="release_date" id="release_date"
