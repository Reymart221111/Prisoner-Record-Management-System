...
<div class="container mx-auto" x-data="{openEditModal: false }">
    ...
    <div class="p-4 mb-6 bg-white rounded-lg shadow">
        <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
            ...
            <div class="flex items-center gap-0">
                <label for="date_from" class="text-sm font-medium text-gray-700 whitespace-nowrap">Death Date
                    From:</label>
            ...
            <div class="flex items-center gap-0">
                <label for="date_to" class="text-sm font-medium text-gray-700 whitespace-nowrap">Death Date To:</label>
    ...
    @livewire('update-prisoner-disease')
    ...
    <div class="overflow-hidden bg-white rounded-lg shadow">
        <table class="min-w-full">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <!-- Sample Row 1 -->
                @foreach ($deadPrisoners as $prisoner)
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900">{{Carbon::parse($prisoner->death_date)->format('M d, Y')}}
                        </div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900">{!!nl2br(e($prisoner->death_cause))!!}</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900">{{Carbon::parse($prisoner->created_at)->format('M d, Y
                            H:i:s')}}</div>
                    </td>

                    <td class="px-6 py-4 text-sm font-medium whitespace-nowrap">
                        <button @click="openEditModal = true" wire:click='$dispatch("editDeadPrisoner", {recordId: {{ $prisoner->id }} })' class="ml-1 text-blue-600 hover:text-green-900"> <i
                                class="fas fa-edit"></i>
                        </button>
                    </td>
                </tr>
