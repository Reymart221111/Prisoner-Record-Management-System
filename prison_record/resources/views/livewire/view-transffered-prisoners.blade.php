...
<div class="container mx-auto" x-data="{openEditModal: false }">
    ...
    @livewire('update-prisoner-transfers')
    ...
    <div class="overflow-hidden bg-white rounded-lg shadow">
        <table class="min-w-full">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <!-- Sample Row 1 -->
                @foreach ($transfferedPrisoners as $prisoner)
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900">{{Carbon::parse($prisoner->transfer_date)->format('M d, Y')}}
                        </div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
