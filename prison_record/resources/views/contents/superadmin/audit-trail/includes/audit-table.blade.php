                ...
                <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td class="px-6 py-4">
                        <span class="px-3 py-1 text-xs rounded-full 
                            ...
                            @elseif($activity->event === 'attached') bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300
                            @elseif($activity->event === 'detached') bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300
                            @endif">
                            {{ $activity->event }}
                        </span>
                    </td>
