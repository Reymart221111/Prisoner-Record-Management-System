<div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8" x-data="@include('includes.x-data')" x-init="initForm">
    <!-- Header -->
    <div class="bg-white rounded-xl shadow-xl">
        ...
        <form wire:submit.prevent="savePrisoner" :class="formClass">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <input type="text" id="prisoner_id" wire:model.live="prisoner_id" readonly
                            class="mt-2 w-full rounded-lg border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('prisoner_id') border-red-500 @enderror">
                        @error('prisoner_id')
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <label for="current_medications" class="block text-sm font-medium text-gray-700">Current
                                Medications</label>
                            <textarea id="current_medications" wire:model.live="current_medications" rows="7"
                                class="mt-2 w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                ...
                                <div class="flex justify-center px-6 py-6 border-2 border-dashed rounded-lg" :class="{
                'border-blue-300 bg-blue-50': photoPreview,
                'border-red-300 bg-red-50': @js($errors->has('photo')),
                'border-gray-300': !photoPreview && !@js($errors->has('photo'))
            }">
