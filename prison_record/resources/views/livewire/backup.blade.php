<div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8" x-data="{ 
    ...
    handleFormSubmission() {
        this.flashMessage = 'Prisoner record saved successfully!';
        this.showFlashMessage = true;
        setTimeout(() => this.showFlashMessage = false, 5000); // auto-hide after 5 seconds
    }
}" x-init="initForm">
    ...
    <template x-if="showFlashMessage">
        <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-4" role="alert">
            ...
            <span @click="showFlashMessage = false" class="absolute top-0 bottom-0 right-0 px-4 py-3 cursor-pointer">
